    ...
    <div class="md:fixed md:buttom-36 md:right-14 md:p-10 pt-6 pb-16 flex justify-center">
        <div class="flex">
            <?php if ($pagina > 1) { ?>
                <div>
                    <button>
                        <a href="./mainJ.php?pagina=<?php echo $pagina - 1 ?>" onClick="localStorage.setItem('N_pag','<?php echo $pagina - 1 ?>')" class="flex items-center justify-center px-5 h-10 me-3 text-base font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700">
            ...
            <?php if ($pagina < $paginas) { ?>
                <div>
                    <button>
                        <a href="./mainJ.php?pagina=<?php echo $pagina + 1 ?>" onClick="localStorage.setItem('N_pag','<?php echo $pagina + 1 ?>')" class="flex items-center justify-center px-5 h-10 text-base font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700">
